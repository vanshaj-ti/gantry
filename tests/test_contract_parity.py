...
class TestTransitionsSnapshotStability(unittest.TestCase):
    ...
    def test_status_string_values_frozen(self):
        expected = {
            ...
            "awaiting_definition", "definition_running", "definition_complete",
            "definition_failed",
            ...
            "design_changes_requested", "definition_changes_requested",
            "checks_running", "checks_passed", "checks_failed",
            "e2e_running", "e2e_passed", "e2e_failed", "e2e_skipped",
            "e2e_escalated",
